...
import 'package:hoooob_app/features/auth/domain/enums/refund_status_enum.dart';
...
import 'package:hoooob_app/features/refund_request/screens/image_Video_viewer.dart';
import 'package:hoooob_app/features/refund_request/screens/refund_request_screen.dart';
...
import 'package:hoooob_app/features/trip/widgets/customer_note_view_widget.dart';
import 'package:hoooob_app/features/trip/widgets/parcel_details_widget.dart';
import 'package:hoooob_app/features/trip/widgets/rider_info.dart';
import 'package:hoooob_app/features/trip/widgets/trip_details.dart';
...
class TripeDetailsScreen extends StatefulWidget {
  ...
  const TripeDetailsScreen({super.key, required this.tripId,this.fromNotification = false});
          ...
          return PopScope(
            ...
            child: BodyWidget(
              ...
              body: Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                child: GetBuilder<TripeController>(builder: (activityController) {
