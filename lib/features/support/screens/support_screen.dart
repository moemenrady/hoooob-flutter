...
import 'package:hoooob_app/features/support/widgets/contact_us_view.dart';
import 'package:hoooob_app/features/support/widgets/help_support_type_button_widget.dart';
                    ...
                    itemBuilder: (context, index) {
                      return SizedBox(
                          ...
                          child: HelpSupportTypeButtonWidget(
                            profileTypeName:
                                supportController.helpAndSupportTabs[index],
                            index: index,
                          ));
                    },
                  ),
