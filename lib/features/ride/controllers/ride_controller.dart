...
import 'package:hoooob_app/features/parcel/domain/models/parcel_estimated_fare_model.dart';
...
import 'package:hoooob_app/features/ride/domain/models/bidding_model.dart';
import 'package:hoooob_app/features/ride/domain/models/estimated_fare_model.dart';
import 'package:hoooob_app/features/ride/domain/models/final_fare_model.dart';
import 'package:hoooob_app/features/ride/domain/models/nearest_driver_model.dart';
import 'package:hoooob_app/features/ride/domain/models/remaining_distance_model.dart';
import 'package:hoooob_app/features/ride/domain/models/trip_details_model.dart';
...
class RideController extends GetxController implements GetxService {
  ...
  Future<Response> tripStatusUpdate(
    ...
    if (response.statusCode == 200) {
      Get.find<TripeController>().othersCancellationController.clear();
