...
import 'package:hoooob_app/features/coupon/widget/offer_coupon_card_widget.dart';
...
import 'package:hoooob_app/features/my_offer/widgets/discount_cart_widget.dart';
import 'package:hoooob_app/features/my_offer/widgets/no_coupon_widget.dart';
      ...
      child: Scaffold(
        body: BodyWidget(
          ...
          body: Padding(
            ...
            child: Container(
              // color: !widget.isCoupon ? Color(0xffF8F7FC) : null,
                          ...
                          ? GetBuilder<OfferController>(
                              ...
                              return (offerController.bestOfferModel!.data !=
                                  ...
                                  : NoCouponWidget(
                                      ...
                                      description:
                                          'sorry_there_is_no_discount'.tr,
                                    );
                            })
                          : GetBuilder<CouponController>(
                              builder: (couponController) {
                              return (couponController.couponModel!.data !=
                                          null &&
                                      couponController
                                  ...
                                  ? PaginatedListWidget(
                                      ...
                                      totalSize: couponController
                                          .couponModel?.totalSize,
