...
class AddCarRepository implements AddCarRepositoryInterface {
  ...
  Future<Response> getVehicleList() async {
    return apiClient.getData(AppConstants.vehicleList);
  }

  @override
  Future<Response> getVehicleCategoryList() async {
    return apiClient.getData(AppConstants.carMainCategory + '0');
  }

  @override
  Future<Response> deleteVehicle(String vehicleId) async {
    return apiClient.deleteData('${AppConstants.deleteVehicle}/$vehicleId');
  }
