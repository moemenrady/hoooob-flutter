...
class AddCarServices implements AddCarServiceInterface {
  ...
  Future getVehicleList() {
    return addCarRepositoryInterface.getVehicleList();
  }

  @override
  Future getVehicleCategoryList() {
    return addCarRepositoryInterface.getVehicleCategoryList();
  }

  @override
  Future deleteVehicle(String vehicleId) {
    return addCarRepositoryInterface.deleteVehicle(vehicleId);
  }
}
