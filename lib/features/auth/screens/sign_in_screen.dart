...
import 'package:hoooob_app/features/auth/screens/otp_log_in_screen.dart';
import 'package:hoooob_app/features/auth/screens/sign_up_screen.dart';
  ...
  void initState() {
    ...
    if (Get.find<AuthController>().getLoginCountryCode(false).isNotEmpty) {
      Get.find<AuthController>().countryDialCode =
          '+20' /* Get.find<AuthController>().getLoginCountryCode(false) */;
