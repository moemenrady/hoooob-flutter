...
import 'package:hoooob_app/features/address/screens/search_and_pick_location_screen.dart';
              ...
              child: Column(
                  ...
                  children: [
                    Stack(children: [
                      ...
                      Positioned(
                          child: Padding(
                        padding: EdgeInsets.only(top: size.height * .21),
                        child: Align(
                      ...
                      child: SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) => InkWell(
                              onTap: () => addressController.updateAddressIndex(
                                  index, true),
                              child: Padding(
                                padding: const EdgeInsets.only(
