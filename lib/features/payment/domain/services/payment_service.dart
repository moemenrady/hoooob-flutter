...
class PaymentService implements PaymentServiceInterface {
  ...
  @override
  Future withdrawRequest({required String withdrawMethod, required double amount}) async {
    return paymentRepositoryInterface.withdrawRequest(withdrawMethod: withdrawMethod, amount: amount);
  }
}
