...
import 'package:hoooob_app/features/maintainance_mode/maintainance_screen.dart';
import 'package:hoooob_app/features/onboard/screens/onboarding_screen.dart';
...
import 'package:hoooob_app/features/splash/screens/app_version_warning_screen.dart';
import 'package:hoooob_app/features/trip/controllers/trip_controller.dart';
import 'package:hoooob_app/helper/firebase_helper.dart';
import 'package:hoooob_app/helper/notification_helper.dart';
...
import 'package:hoooob_app/features/auth/screens/sign_in_screen.dart';
...
import 'package:hoooob_app/features/location/view/access_location_screen.dart';
...
class _SplashScreenState extends State<SplashScreen>
  ...
  void _handleIncomingLinks() {
    Get.find<TripeController>().getRideCancellationReasonList();
    Get.find<TripeController>().getParcelCancellationReasonList();
...
// Function to check the user profile and location and route accordingly for login user
...
// Updated function to check the user profile and route accordingly for login user without checking location
  void forLoginUserRoute() {
    if (widget.notificationData != null) {
      ...
      Get.find<ProfileController>().getProfileInfo().then((value) {
        if (value.statusCode == 200) {
          ...
          if (value.body['data']['is_profile_verified'] == 1) {
            Get.find<AuthController>().remainingFindingRideTime();
            // بدل ما نروح AccessLocationScreen، نروح Dashboard
            Get.offAll(() => const DashboardScreen());
          } else {
            Get.offAll(() => const EditProfileScreen(fromLogin: true));
          }
              ...
              child: Column(children: [
                Opacity(
                  ...
                  child: Padding(
                    ...
                    child: Image.asset(Images.splashLogo, width: 190),
                  ),
                ),
              ]),
            ),
