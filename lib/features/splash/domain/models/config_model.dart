...
class PaymentGateways {
  ...
  PaymentGateways.fromJson(Map<String, dynamic> json) {
    gateway = json['key_name'];
    isActive = json['is_active'];

    if (json['additional_data'] != null) {
      final additionalData = jsonDecode(json['additional_data']);

      gatewayTitle = additionalData['gateway_title'];
      gatewayImage = additionalData['gateway_image'];
    }
  }
}
