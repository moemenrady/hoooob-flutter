...
import 'package:hoooob_app/features/home/widgets/banner_shimmer.dart';
...
import 'package:hoooob_app/features/map/widget/ride_cancelation_radio_button.dart';
import 'package:hoooob_app/features/parcel/widgets/otp_widget.dart';
import 'package:hoooob_app/features/parcel/widgets/route_widget.dart';
import 'package:hoooob_app/features/parcel/widgets/tolltip_widget.dart';
import 'package:hoooob_app/features/payment/screens/payment_screen.dart';
import 'package:hoooob_app/features/ride/controllers/ride_controller.dart';
import 'package:hoooob_app/features/ride/widgets/estimated_fare_and_distance.dart';
import 'package:hoooob_app/features/trip/controllers/trip_controller.dart';
import 'package:hoooob_app/features/trip/widgets/rider_details.dart';
             ...
             Row(children: [
               ...
               Expanded(child: ButtonWidget(buttonText: 'submit'.tr,
                 ...
                 if(rideController.currentRideState == RideState.acceptingRider){
                   ...
                   rideController.tripStatusUpdate(rideController.tripDetails!.id!, 'cancelled', 'ride_request_cancelled_successfully',Get.find<TripeController>().rideCancellationReasonList!.data!.acceptedRide![Get.find<TripeController>().rideCancellationCauseCurrentIndex]).then((value){
                   ...
                   rideController.tripStatusUpdate(rideController.tripDetails!.id!, 'cancelled', 'ride_request_cancelled_successfully', Get.find<TripeController>().rideCancellationReasonList!.data!.ongoingRide![Get.find<TripeController>().rideCancellationCauseCurrentIndex], afterAccept: true).then((value) async {
                     if(value.statusCode == 200){
                       Get.find<RideController>().stopLocationRecord();
