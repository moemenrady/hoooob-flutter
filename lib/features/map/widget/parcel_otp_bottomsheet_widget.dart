...
import 'package:hoooob_app/features/map/widget/parcel_cancelation_list.dart';
      ...
      return GetBuilder<RideController>(builder: (rideController){
        ...
        Column( crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: Text(
              Get.find<TripeController>().parcelCancellationReasonList!.data!.acceptedRide!.length > 1 ?
              ...
              onPressed: (){
                ...
                rideController.tripStatusUpdate(
                  rideController.tripDetails!.id!, 'cancelled', 'parcel_request_cancelled_successfully',
                    (Get.find<TripeController>().parcelCancellationReasonList!.data!.acceptedRide!.length - 1) == Get.find<TripeController>().parcelCancellationCauseCurrentIndex ?
                    Get.find<TripeController>().othersCancellationController.text :
                    Get.find<TripeController>().parcelCancellationReasonList!.data!.acceptedRide![Get.find<TripeController>().parcelCancellationCauseCurrentIndex]
                );
