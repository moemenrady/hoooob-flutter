      ...
      return GetBuilder<RideController>(builder: (rideController){
        ...
        Column( crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: Text(
              Get.find<TripeController>().parcelCancellationReasonList!.data!.ongoingRide!.length > 1 ?
          ...
          ButtonWidget(buttonText: 'yes_cancel'.tr,
            ...
            onPressed: (){
              ...
              rideController.tripStatusUpdate(
                  ...
                  (Get.find<TripeController>().parcelCancellationReasonList!.data!.ongoingRide!.length - 1) == Get.find<TripeController>().parcelCancellationCauseCurrentIndex ?
                  Get.find<TripeController>().othersCancellationController.text :
                  Get.find<TripeController>().parcelCancellationReasonList!.data!.ongoingRide![Get.find<TripeController>().parcelCancellationCauseCurrentIndex],
                  afterAccept: true
              ).then((value){
