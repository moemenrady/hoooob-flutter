...
import 'package:hoooob_app/features/message/screens/message_screen.dart';
import 'package:hoooob_app/features/my_level/controller/level_controller.dart';
import 'package:hoooob_app/features/my_level/widget/level_complete_dialog_widget.dart';
...
import 'package:hoooob_app/features/payment/screens/review_screen.dart';
...
import 'package:hoooob_app/features/ride/widgets/confirmation_trip_dialog.dart';
import 'package:hoooob_app/features/settings/domain/html_enum_types.dart';
import 'package:hoooob_app/features/settings/screens/policy_screen.dart';
...
import 'package:hoooob_app/main.dart';
    ...
    Get.find<RideController>().getRideDetails(tripId).then((value) => {
      if(Get.find<RideController>().tripDetails!.currentStatus == 'accepted' || Get.find<RideController>().tripDetails!.currentStatus == 'ongoing'){
        ...
        if(Get.currentRoute != '/TripDetailsScreen'){
          _toRoute(formSplash, TripeDetailsScreen(tripId: tripId,fromNotification: true)),
