...
import 'package:hoooob_app/features/add_tripe/domain/repository/add_tripe_reepository.dart';
import 'package:hoooob_app/features/add_tripe/domain/repository/add_tripe_repository_interface.dart';
import 'package:hoooob_app/features/add_tripe/domain/services/add_tripe_services.dart';
...
import 'package:hoooob_app/features/details_tripe/domain/repository/details_tripe_repository.dart';
import 'package:hoooob_app/features/details_tripe/domain/repository/details_tripe_repository_interface.dart';
import 'package:hoooob_app/features/details_tripe/domain/services/details_tripe_services.dart';
...
import 'package:hoooob_app/features/home/domain/repositories/add_car_repository.dart';
...
import 'package:hoooob_app/features/home/domain/services/add_car_services.dart';
import 'package:hoooob_app/features/home/domain/services/add_car_services_interface.dart';
import 'package:flutter/services.dart';
import 'package:hoooob_app/features/address/domain/repositories/address_repository_interface.dart';
import 'package:hoooob_app/features/address/domain/services/address_service.dart';
import 'package:hoooob_app/features/address/domain/services/address_service_interface.dart';
import 'package:hoooob_app/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:hoooob_app/features/auth/domain/services/auth_service.dart';
import 'package:hoooob_app/features/auth/domain/services/auth_service_interface.dart';
import 'package:hoooob_app/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:hoooob_app/features/coupon/domain/services/coupon_service.dart';
import 'package:hoooob_app/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:hoooob_app/features/home/domain/repositories/category_repo.dart';
import 'package:hoooob_app/features/home/domain/services/search_tripe_services_interface.dart';
import 'package:hoooob_app/features/location/domain/repositories/location_repository.dart';
import 'package:hoooob_app/features/location/domain/repositories/location_repository_interface.dart';
import 'package:hoooob_app/features/location/domain/services/location_service.dart';
import 'package:hoooob_app/features/location/domain/services/location_service_interface.dart';
import 'package:hoooob_app/features/message/domain/repositories/message_repository.dart';
import 'package:hoooob_app/features/message/domain/repositories/message_repository_interface.dart';
import 'package:hoooob_app/features/message/domain/services/message_service.dart';
import 'package:hoooob_app/features/message/domain/services/message_service_interface.dart';
import 'package:hoooob_app/features/my_level/controller/level_controller.dart';
import 'package:hoooob_app/features/my_level/domain/repositories/level_repository.dart';
import 'package:hoooob_app/features/my_level/domain/repositories/level_repository_interface.dart';
import 'package:hoooob_app/features/my_level/domain/services/level_service.dart';
import 'package:hoooob_app/features/my_level/domain/services/level_service_interface.dart';
import 'package:hoooob_app/features/my_offer/controller/offer_controller.dart';
import 'package:hoooob_app/features/my_offer/domain/repositories/offer_repository.dart';
import 'package:hoooob_app/features/my_offer/domain/repositories/offer_repository_interface.dart';
import 'package:hoooob_app/features/my_offer/domain/services/offer_service.dart';
import 'package:hoooob_app/features/my_offer/domain/services/offer_service_interface.dart';
import 'package:hoooob_app/features/notification/controllers/notification_controller.dart';
import 'package:hoooob_app/features/notification/domain/repositories/notification_repository.dart';
import 'package:hoooob_app/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:hoooob_app/features/notification/domain/services/notification_service.dart';
import 'package:hoooob_app/features/notification/domain/services/notification_service_interface.dart';
import 'package:hoooob_app/features/onboard/controllers/on_board_page_controller.dart';
import 'package:hoooob_app/features/parcel/domain/repositories/parcel_repository.dart';
import 'package:hoooob_app/features/parcel/domain/repositories/parcel_repository_interface.dart';
import 'package:hoooob_app/features/parcel/domain/services/parcel_service.dart';
import 'package:hoooob_app/features/parcel/domain/services/parcel_service_interface.dart';
import 'package:hoooob_app/features/payment/controllers/payment_controller.dart';
import 'package:hoooob_app/features/payment/domain/repositories/payment_repository.dart';
import 'package:hoooob_app/features/payment/domain/repositories/payment_repository_interface.dart';
import 'package:hoooob_app/features/payment/domain/services/payment_service.dart';
import 'package:hoooob_app/features/payment/domain/services/payment_service_interface.dart';
import 'package:hoooob_app/features/profile/domain/repositories/profile_repository.dart';
import 'package:hoooob_app/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:hoooob_app/features/profile/domain/services/profile_service.dart';
...
import 'package:hoooob_app/features/refer_and_earn/domain/repositories/refer_earn_repository.dart';
import 'package:hoooob_app/features/refer_and_earn/domain/repositories/refer_earn_repository_interface.dart';
import 'package:hoooob_app/features/refer_and_earn/domain/services/refer_earn_service.dart';
import 'package:hoooob_app/features/refer_and_earn/domain/services/refer_earn_service_interface.dart';
import 'package:hoooob_app/features/refund_request/controllers/refund_request_controller.dart';
import 'package:hoooob_app/features/refund_request/domain/repositories/refund_request_repository.dart';
import 'package:hoooob_app/features/refund_request/domain/repositories/refund_request_repository_interface.dart';
import 'package:hoooob_app/features/refund_request/domain/services/refund_request_service.dart';
import 'package:hoooob_app/features/refund_request/domain/services/refund_request_service_interface.dart';
import 'package:hoooob_app/features/ride/domain/repositories/ride_repository.dart';
import 'package:hoooob_app/features/ride/domain/repositories/ride_repository_interface.dart';
import 'package:hoooob_app/features/ride/domain/services/ride_service.dart';
import 'package:hoooob_app/features/ride/domain/services/ride_service_interface.dart';
import 'package:hoooob_app/features/home/controllers/search_tripe_controller.dart';
import 'package:hoooob_app/features/home/domain/repositories/search_tripe_repository.dart';
import 'package:hoooob_app/features/home/domain/services/search_tripe_services.dart';
import 'package:hoooob_app/features/splash/domain/repositories/config_repository.dart';
import 'package:hoooob_app/features/splash/domain/repositories/config_repository_interface.dart';
import 'package:hoooob_app/features/splash/domain/services/config_service.dart';
import 'package:hoooob_app/features/splash/domain/services/config_service_interface.dart';
import 'package:hoooob_app/features/station_points/domain/repositories/station_points_repository.dart';
import 'package:hoooob_app/features/station_points/domain/repositories/station_points_repository_interface.dart';
import 'package:hoooob_app/features/station_points/domain/services/station_point_service.dart';
...
import 'package:hoooob_app/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:hoooob_app/features/dashboard/controllers/bottom_menu_controller.dart';
import 'package:hoooob_app/features/address/controllers/address_controller.dart';
import 'package:hoooob_app/features/home/controllers/banner_controller.dart';
import 'package:hoooob_app/features/home/controllers/category_controller.dart';
import 'package:hoooob_app/features/address/domain/repositories/address_repository.dart';
import 'package:hoooob_app/features/home/domain/repositories/banner_repo.dart';
...
import 'package:hoooob_app/features/auth/domain/repositories/auth_repository.dart';
import 'package:hoooob_app/features/message/controllers/message_controller.dart';
...
import 'package:hoooob_app/features/trip/domain/repositories/trip_repository.dart';
import 'package:hoooob_app/features/trip/domain/repositories/trip_repository_interface.dart';
import 'package:hoooob_app/features/trip/domain/services/service.dart';
...
import 'package:hoooob_app/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:hoooob_app/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:hoooob_app/features/wallet/domain/services/wallet_service.dart';
import 'package:hoooob_app/features/wallet/domain/services/wallet_service_interface.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  Get.lazyPut(() => StationService(stationRepository: Get.find()));
  ...
  Get.lazyPut<StationRepositoryInterface>(
    () => StationRepository(apiClient: Get.find()),
  );
  // Controller
  ...
  Get.lazyPut(() => TripeController(tripServiceInterface: Get.find()));
  ...
  Get.lazyPut<LocationController>(
    () => LocationController(
      locationServiceInterface: Get.find<LocationServiceInterface>(),
      stationService: Get.find<StationServiceInterface>(),
    ),
  );
  // Register AddCar dependencies first
  Get.lazyPut(() => AddCarRepository(apiClient: Get.find()));
  Get.lazyPut<AddCarRepositoryInterface>(
    () => AddCarRepository(apiClient: Get.find()),
  );

  AddCarServiceInterface addCarServiceInterface =
      AddCarServices(addCarRepositoryInterface: Get.find());
  Get.lazyPut<AddCarServiceInterface>(() => addCarServiceInterface);

  Get.lazyPut(() => AddTripeController(addTripeServiceInterface: Get.find()));
  Get.lazyPut(() => SearchTripeController(
      searchTripeServiceInterface: Get.find(),
      addCarServiceInterface: Get.find()));
  Get.lazyPut(
      () => DetailsTripeController(detailsTripeServiceInterface: Get.find()));
  ...
  Get.lazyPut(() => AddCarController(addCarServiceInterface: Get.find()));
  ...
  AddTripeRepositoryInterface addTripeRepositoryInterface =
      AddTripeRepository(apiClient: Get.find());
  Get.lazyPut(() => addTripeRepositoryInterface);
  ...
  AddTripeServiceInterface addTripeServiceInterface =
      AddTripeService(addTripeRepositoryInterface: Get.find());
  Get.lazyPut(() => addTripeServiceInterface);
  ...
  DetailsTripeRepositoryInterface detailsTripeRepositoryInterface =
      DetailsTripeRepository(apiClient: Get.find());
  Get.lazyPut(() => detailsTripeRepositoryInterface);

  DetailsTripeServiceInterface detailsTripeServiceInterface =
      DetailsTripeService(addTripeRepositoryInterface: Get.find());
  Get.lazyPut(() => detailsTripeServiceInterface);
  ...
  StationServiceInterface stationServiceInterface =
      StationService(stationRepository: Get.find());
  Get.lazyPut(() => stationServiceInterface);
